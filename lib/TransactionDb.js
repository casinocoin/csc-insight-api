...
var genesisTXID = '73d304deca65f150913c0f87305dec7aa3913919889e483aa04bda87133023e6';
var CONCURRENCY = 10;
...
var encodedData = require('soop').load('csc-bitcore-v0.1/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('csc-bitcore-v0.1/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('csc-bitcore-v0.1/lib/Address', {
